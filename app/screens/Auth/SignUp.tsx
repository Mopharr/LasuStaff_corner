...
export const SignUp: FC<LoginScreenProps> = observer(function SignUp(_props) {
  ...
  return (
    <ImageBackground source={require("../../Asset/Image/bg.png")} style={$screenContentContainer}>
      <View style={$wra}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate("Home")} style={$btn}>
          <Text style={$btnT}>SIGN UP</Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => navigation.navigate("Auth", { screen: "getStarted" })}
          style={$sn}
        >
          <Text style={$tx}>
            Already have an account? <Text style={$txx}>Sign in</Text>
          </Text>
        </TouchableOpacity>
      </View>
    </ImageBackground>
